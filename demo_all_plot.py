...
# Five solvers.
solvers = ["ASTRODFRP", "ASTRODFRF", "ASTRODFREG", "ASTRODFORG", "ADAM", "ALOE", "STORM", "NELDMD", "STRONG"]
...
for solver in solvers:
    ...
    if solver == "ASTRODFRF":
        solver_display = "Refined ASTRO-DF (interpolation)"
    elif solver == "ASTRODFRP":
        solver_display = "History-informed ASTRO-DF"
    elif solver == "ASTRODFREG":
        solver_display = "Refined ASTRO-DF (regression)"
