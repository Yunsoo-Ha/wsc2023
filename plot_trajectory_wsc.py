...
def plot_with_conf_interval(file1, file2, ylabel, output):
    ...
    plt.plot(x, mean1, color='C0', label='History-informed ASTRO-DF')
    plt.fill_between(x, y_lower1, y_upper1, alpha=0.2, color='C0')

    plt.plot(x, mean2, color='C1', label='ASTRO-DF')
...
# Plot RSBR
plot_with_conf_interval('delta_rsbr_rp.npy', 'delta_rsbr_rf.npy', 'Delta', f"experiments/plots/delta_rsbr_trajectory_wsc.pdf")

# Plot SAN
plot_with_conf_interval('delta_san_rp.npy', 'delta_san_rf.npy', 'Delta', f"experiments/plots/delta_san_trajectory_wsc.pdf")
